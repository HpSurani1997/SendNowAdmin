const FleetTonnageCard = () => {
  return (
    <div className="card full-height">
      <div className="mb-4 card-header-content d-flex align-items-center justify-content-between flex-wrap">
        <div className="me-4">
          <h6 className="mb-1">Our Fleet Tonnage</h6>
          <p className="mb-0">Total 1,247 vehicles</p>
        </div>
        <button className="btn btn-lean">Review Fleet</button>
      </div>

      <div className="fleet-tonnage-wrap">
        <div className="fleet-tonnage-card d-flex align-items-center">
          <div className="icon">
            <svg
          ...
          <div className="content d-flex align-items-center justify-content-between">
            <div>
              <p className="mb-0">Ships</p>
              <p className="mb-0">234 Ships</p>
            </div>
            <div className="text-end">
              <p className="mb-0">2,345,500</p>
              <p className="mb-0">Tons</p>
            </div>
          </div>
        </div>
        ...
        <div className="fleet-tonnage-card d-flex align-items-center">
          ...
          <div className="content d-flex align-items-center justify-content-between">
            <div>
              <p className="mb-0">Trucks</p>
              <p className="mb-0">1,460 Trucks</p>
            </div>
            <div className="text-end">
              <p className="mb-0">457,200</p>
              <p className="mb-0">Tons</p>
            </div>
          </div>
        </div>
        ...
        <div className="fleet-tonnage-card d-flex align-items-center">
          ...
          <div className="content d-flex align-items-center justify-content-between">
            <div>
              <p className="mb-0">Planes</p>
              <p className="mb-0">8 Aircrafts</p>
            </div>
            <div className="text-end">
        ...
        <div className="fleet-tonnage-card d-flex align-items-center">
          ...
          <div className="content d-flex align-items-center justify-content-between">
            <div>
              <p className="mb-0">Trucks</p>
              <p className="mb-0">36 Trucks</p>
            </div>
            <div className="text-end">
              <p className="mb-0">804,300</p>
              <p className="mb-0">Tons</p>
            </div>
          </div>
        </div>
...
export default FleetTonnageCard;
